            ...
            if (Process == ProcesType.Alive)
            {
                if (DateTime.Now > StartTimer.AddSeconds(5))
                {
                    ...
                    if (array.Length > 0)
                    {
                        ...
                        if (Winner != null && (Winner.Player.KingOfTheHillScore >= 80 || DateTime.Now > StartTimer.AddMinutes(5)))
                        {
                            ...
                            Winner.Player.ConquerPoints += 10000;
                            string reward = "[EVENT]" + Winner.Player.Name + " has received 10,000 CPs from KOH.";
                            ...
                            using (var rec = new ServerSockets.RecycledPacket())
                            {
                                ...
                                Winner.SendSysMesage("You received 10,000 ConquerPoints and 2 PowerExpBalls. ", MsgServer.MsgMessage.ChatMode.System, MsgServer.MsgMessage.MsgColor.red);
                            }
                ...
                if (DateTime.Now > ScoreStamp)
                {
                    ...
                    using (var rec = new ServerSockets.RecycledPacket())
                    {
                        ...
                        Game.MsgServer.MsgMessage msg = new MsgServer.MsgMessage("ScoreBoard: (1st to 300 wins)", MsgServer.MsgMessage.MsgColor.yellow, MsgServer.MsgMessage.ChatMode.FirstRightCorner);
