    ...
    public class MsgSkillTeamPkTournament
    {
        ...
        public void Start()
        {
            if (Proces == ProcesType.Dead)
            {
                ...
                {
                    client.Player.MessageBox("The Skill Team PK Tournament will start at 22:00. Prepare yourself and sign up for it as a team!", new Action<Client.GameClient>(p => p.Teleport(445, 242, 1002, 0)), null, 60, MsgServer.MsgStaticMessage.Messages.None);
                }
            }
        }
        public void Save()
            ...
            foreach (var tournament in EliteGroups)
            {
                ...
                if (tournament.GetReward(client, out Rank))
                {
                    ...
                    if (Rank == 1)
                    {
                        ...
                        client.CreateBoxDialog("You've received 50,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Skill Team Tournament and claimed 50,000 Conquer Points.";
                    ...
                    else if (Rank == 2)
                    {
                        ...
                        client.CreateBoxDialog("You've received 25,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Skill Team Tournament and claimed 25,000 Conquer Points.";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    }
                    else if (Rank == 3)
                    {
                        client.Player.ConquerPoints += 15000;
                        client.CreateBoxDialog("You've received 15,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Skill Team Tournament and claimed 15,000 Conquer Points .";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    }
                    else
                    {
                        client.Player.ConquerPoints += 5000;
                        client.CreateBoxDialog("You've received 5,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Skill Team Tournament and claimed 5,000 Conquer Points.";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    }
    ...
    public class MsgTeamPkTournament
    {
        ...
        public void Start()
        {
            if (Proces == ProcesType.Dead)
            {
                ...
                foreach (var client in Database.Server.GamePoll.Values)
                {
                    client.Player.MessageBox("", new Action<Client.GameClient>(p => p.Teleport(420, 246, 1002, 0)), null, 60, MsgServer.MsgStaticMessage.Messages.TeamPkTournament);
                }
            }
        }
        public void Save()
        ...
        public bool GetReward(Client.GameClient client, ServerSockets.Packet stream)
        {
            foreach (var tournament in EliteGroups)
            {
                ...
                if (tournament.GetReward(client, out Rank))
                {
                    ...
                    {
                        client.Player.ConquerPoints += 15000;
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 15000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Team Pk Tournament and claimed 15,000 Conquer Points & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    }
                    else if (Rank == 2)
                    {
                        client.Player.ConquerPoints += 10000;
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 10000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Team Pk Tournament and claimed 5,000 Conquer Points & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    }
                    else if (Rank == 3)
                    {
                        client.Player.ConquerPoints += 8000;
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 8000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Team Pk Tournament and claimed 8,000 Conquer Points & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    }
                    else
                    {
                        client.Player.ConquerPoints += 5000;
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 5000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Team Pk Tournament and claimed 5,000 Conquer Points & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    }
                    return true;
